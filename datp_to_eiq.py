    ...
    if len(alerts) > 0:
        ...
        for machineName in machineNames:
            ...
            for alertId in alertIds:
                ...
                jsonIndicator['determination'] = 'Autopatcher'
                jsonIndicator['comment'] = 'DATP-to-EIQ ingester has imported alert into EIQ'
            ...
            for indicator in jsonIndicators:
                ...
                if options.simulate and settings.AUTOPATCH:
                    print("U) Not autopatching because simulate mode set!")
    return(entityList)
